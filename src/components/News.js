...
const News = (props) => {
  ...
  const updateNews = async () => {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=889e863655ab40cc9eb4450efea7a05c&page=${page}&pageSize=${props.pageSize}`;
    setLoading(true);
